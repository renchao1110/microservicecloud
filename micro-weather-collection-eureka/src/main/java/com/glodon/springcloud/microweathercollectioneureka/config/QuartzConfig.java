package com.glodon.springcloud.microweathercollectioneureka.config;

import com.glodon.springcloud.microweathercollectioneureka.constants.Constant;
import com.glodon.springcloud.microweathercollectioneureka.job.WeatherDataSyncJob;
import org.quartz.*;
...
public class QuartzConfig {
    ...
    public Trigger weatherDataSyncTrigger(){
        ...
        return TriggerBuilder.newTrigger().forJob(weatherDataSyncDetail())
                .withIdentity("weatherDataSyncTrigger").startNow()
